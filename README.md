...
### Список ссылок с вопросами для собеседования
  ...
  44. Задача "Рекурсивный поиск элемента в дереве объектов":
  ...
  45. Задача "Реализация Promise.all()":
  ...
  46. Создайте Promise, который успешно завершится через 2 секунды.
 
  47. Создайте Promise, который будет отклонен через 1 секунду.
 
  48. Создайте функцию, которая будет возвращать Promise с рандомным числом и после выполнения Promise выведет это число.
  
  49. Напишите код, который реализует выполнение двух Promise параллельно и выведет результат, когда оба Promise завершатся.
  
  50. Реализуйте функцию, которая будет возвращать Promise и будет выполняться через случайное время.
  
  51. Создайте Promise, который будет завершать выполнение через 3 секунды с определенным результатом.
  
  52. Напишите функцию, которая принимает Promise и возвращает новый Promise, который будет отклонен через 2 секунды.
  
  53. Реализуйте Promise, который будет выполняться бесконечное время каждые 2 секунды.
  
  54. Напишите функцию, которая будет принимать массив Promise и возвращать новый Promise, который завершится, когда все Promise в массиве выполнены.
  
  55. Создайте Promise, который будет отклонен после 5 попыток.
  
  56. Напишите код, который будет принимать Promise и перехватывать ошибку, если ее нет.
  
  57. Реализуйте Promise, который будет завершать выполнение с рандомным результатом через определенное время.
  
  58. Напишите функцию, которая будет возвращать Promise и будет выполняться с определенным результатом через случайное время.
  
  59. Создайте Promise, который будет завершать выполнение со случайным результатом после 3 секунд.
  
  60. Напишите функцию, которая принимает Promise и возвращает новый Promise, который будет завершен через 2 секунды.
  
  61. Реализуйте Promise, который будет выполняться каждую секунду и завершаться после 10 итераций.
  
  62. Создайте код, который будет выполнять два Promise по очереди и выводить результат последовательно.
  
  63. Напишите функцию, которая принимает Promise и возвращает новый Promise, который будет успешно завершаться через 1 секунду.
  
  64. Реализуйте Promise, который будет завершен с ошибкой через 1 секунду.
  
  65. Напишите код, который будет выполнять 3 Promise параллельно и выведет результат, когда все Promise завершатся.
