...
### Список ссылок с вопросами для собеседования
  ...
  39. Создайте функцию, которая принимает на вход два массива строк и возвращает новый массив, содержащий только те строки, которые есть и в первом, и во втором массивах.
  ...
  42. Задача "Сортировка массива объектов":
  ...
  43. Задача "Рекурсивный поиск элемента в дереве объектов":
  ...
  44. Задача "Реализация Promise.all()":
